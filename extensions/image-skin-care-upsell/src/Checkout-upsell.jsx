...
import {productByType} from "./queries";
...
const prePurchase = reactExtension("purchase.checkout.block.render", () => <App />);
export { prePurchase };
...
function ProductOffer({ product, i18n, adding, handleAddToCart, showError }) {
  ...
  return (
    <BlockStack spacing='loose'>
      <Divider />
      <Heading level={2}>You might also like - Ed Demo</Heading>
      <BlockStack spacing='loose'>
        <InlineLayout
          spacing='base'
          columns={[64, 'fill', 'auto']}

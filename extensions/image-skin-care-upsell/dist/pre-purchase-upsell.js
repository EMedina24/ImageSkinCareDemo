(() => {
  ...
  // extensions/image-skin-care-upsell/src/checkout-upsell.jsx
...
${errorInfo.componentStack}`);
  ...
  // extensions/image-skin-care-upsell/src/queries/products.ts
  var productByType = `query ($first: Int!) {
  ...
  var prePurchase = reactExtension("purchase.checkout.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(App, {}));
  function App() {
  ...
  function ProductOffer({ product, i18n, adding, handleAddToCart, showError }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "loose", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Divider2, {}),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { level: 2, children: "You might also like - Ed Demo" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { spacing: "loose", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        InlineLayout2,
        {
          spacing: "base",
